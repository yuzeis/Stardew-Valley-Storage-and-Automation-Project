...
internal static class ModItemCatalog
{
    ...
    {
        [BasicCircuit] = "(O)338 3 (O)334 1 (O)336 1/Home/(O)" + BasicCircuit + " 1/false/null",
        ...
        [LinkTool] = "(O)335 2 (O)787 1 (O)338 5/Home/(O)" + LinkTool + " 1/false/null",
        ...
        [NetworkCore] = "(O)787 2 (O)337 2 (O)" + AdvancedCircuit + " 1 (O)338 20 (O)336 5/Home/(BC)" + NetworkCore + " 1/true/null",
        [NetworkTerminal] = "(O)787 1 (O)338 10 (O)335 5 (O)336 2 (O)" + BasicCircuit + " 1/Home/(BC)" + NetworkTerminal + " 1/true/null",
        ...
        [StorageDrive] = "(O)335 5 (O)338 10 (O)787 1 (O)" + BasicCircuit + " 1/Home/(BC)" + StorageDrive + " 1/true/null",
